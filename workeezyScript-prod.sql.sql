...
INSERT INTO tb_room
(place_id, room_no, room_people, room_service, room_type)
VALUES
(1, 101, 2, '조식 포함, 오션뷰', 'economy'),
(1, 102, 4, '가족룸, 테라스 포함', 'standard'),
(2, 201, 2, '힐링룸, 숲 전망', 'standard'),
(3, 103, 6, '회의실, TV모니터, 화이트보드', 'superior'),
(3, 204, 1, '1인 집중 부스', 'economy');
